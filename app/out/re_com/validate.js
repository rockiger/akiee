...
*/
re_com.validate.left_string = (function left_string(obj,max_len){
...
* @param {...*} var_args
*/
re_com.validate.log_error = (function() { 
var log_error__delegate = function (args){
console.error(cljs.core.apply.call(null,cljs.core.str,args));

return false;
};
var log_error = function (var_args){
var args = null;
...
return log_error__delegate.call(this,args);};
log_error.cljs$lang$maxFixedArity = 0;
log_error.cljs$lang$applyTo = (function (arglist__5780){
var args = cljs.core.seq(arglist__5780);
return log_error__delegate(args);
});
log_error.cljs$core$IFn$_invoke$arity$variadic = log_error__delegate;
return log_error;
})()
;
/**
...
* @param {...*} var_args
*/
re_com.validate.log_warning = (function() { 
var log_warning__delegate = function (args){
console.warn(cljs.core.apply.call(null,cljs.core.str,args));

return true;
};
var log_warning = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5781__i = 0, G__5781__a = new Array(arguments.length -  0);
while (G__5781__i < G__5781__a.length) {G__5781__a[G__5781__i] = arguments[G__5781__i + 0]; ++G__5781__i;}
  args = new cljs.core.IndexedSeq(G__5781__a,0);
} 
return log_warning__delegate.call(this,args);};
log_warning.cljs$lang$maxFixedArity = 0;
log_warning.cljs$lang$applyTo = (function (arglist__5782){
var args = cljs.core.seq(arglist__5782);
return log_warning__delegate(args);
});
log_warning.cljs$core$IFn$_invoke$arity$variadic = log_warning__delegate;
return log_warning;
})()
;
re_com.validate.hash_map_with_name_keys = (function hash_map_with_name_keys(v){
...
*/
re_com.validate.extract_arg_data = (function extract_arg_data(args_desc){
...
*/
re_com.validate.arg_names_valid_QMARK_ = (function arg_names_valid_QMARK_(defined_args,passed_args){
var or__3757__auto__ = clojure.set.superset_QMARK_.call(null,defined_args,passed_args);
if(or__3757__auto__){
...
*/
re_com.validate.required_args_passed_QMARK_ = (function required_args_passed_QMARK_(required_args,passed_args){
var or__3757__auto__ = clojure.set.superset_QMARK_.call(null,passed_args,required_args);
if(or__3757__auto__){
return or__3757__auto__;
} else {
...
*/
re_com.validate.validate_fns_pass_QMARK_ = (function validate_fns_pass_QMARK_(args_with_validators,passed_args,component_name){
var validate_arg = (function (p__5785){
var vec__5786 = p__5785;
var _ = cljs.core.nth.call(null,vec__5786,(0),null);
var v_arg_def = cljs.core.nth.call(null,vec__5786,(1),null);
...
var log_msg_base = ((function (arg_name,arg_val,required_QMARK_,validate_result,vec__5786,_,v_arg_def){
return (function (){
...
});})(arg_name,arg_val,required_QMARK_,validate_result,vec__5786,_,v_arg_def))
;
...
* @param {...*} var_args
*/
re_com.validate.validate_args = (function() { 
var validate_args__delegate = function (arg_defs,passed_args,component_name){
if(!(goog.DEBUG)){
return true;
} else {
var passed_arg_keys = cljs.core.set.call(null,cljs.core.keys.call(null,passed_args));
return (re_com.validate.arg_names_valid_QMARK_.call(null,new cljs.core.Keyword(null,"arg-names","arg-names",1632831252).cljs$core$IFn$_invoke$arity$1(arg_defs),passed_arg_keys)) && (re_com.validate.required_args_passed_QMARK_.call(null,new cljs.core.Keyword(null,"required-args","required-args",1225806985).cljs$core$IFn$_invoke$arity$1(arg_defs),passed_arg_keys)) && (re_com.validate.validate_fns_pass_QMARK_.call(null,new cljs.core.Keyword(null,"validated-args","validated-args",278814533).cljs$core$IFn$_invoke$arity$1(arg_defs),passed_args,cljs.core.first.call(null,component_name)));
}
};
var validate_args = function (arg_defs,passed_args,var_args){
var component_name = null;
if (arguments.length > 2) {
var G__5787__i = 0, G__5787__a = new Array(arguments.length -  2);
while (G__5787__i < G__5787__a.length) {G__5787__a[G__5787__i] = arguments[G__5787__i + 2]; ++G__5787__i;}
  component_name = new cljs.core.IndexedSeq(G__5787__a,0);
} 
return validate_args__delegate.call(this,arg_defs,passed_args,component_name);};
validate_args.cljs$lang$maxFixedArity = 2;
validate_args.cljs$lang$applyTo = (function (arglist__5788){
var arg_defs = cljs.core.first(arglist__5788);
arglist__5788 = cljs.core.next(arglist__5788);
var passed_args = cljs.core.first(arglist__5788);
var component_name = cljs.core.rest(arglist__5788);
return validate_args__delegate(arg_defs,passed_args,component_name);
});
validate_args.cljs$core$IFn$_invoke$arity$variadic = validate_args__delegate;
...
*/
re_com.validate.validate_arg_against_set = (function validate_arg_against_set(arg,arg_name,valid_set){
var arg__$1 = re_com.util.deref_or_value.call(null,arg);
var or__3757__auto__ = cljs.core.not_EQ_.call(null,cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([arg__$1],true),valid_set),null);
if(or__3757__auto__){
return or__3757__auto__;
} else {
...
*/
re_com.validate.make_code_list = (function make_code_list(codes){
return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991)], null),cljs.core.interpose.call(null,", ",cljs.core.map.call(null,(function (p1__5789_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"code","code",1586293142),[cljs.core.str(p1__5789_SHARP_)].join('')],null));
}),codes)));
});
...
*/
re_com.validate.string_or_hiccup_QMARK_ = (function string_or_hiccup_QMARK_(arg){
...
*/
re_com.validate.vector_of_maps_QMARK_ = (function vector_of_maps_QMARK_(arg){
var arg__$1 = re_com.util.deref_or_value.call(null,arg);
...
*/
re_com.validate.css_style_QMARK_ = (function css_style_QMARK_(arg){
if(!(goog.DEBUG)){
return true;
} else {
var arg__$1 = re_com.util.deref_or_value.call(null,arg);
var and__3745__auto__ = cljs.core.map_QMARK_.call(null,arg__$1);
if(and__3745__auto__){
var arg_keys = cljs.core.keys.call(null,arg__$1);
var or__3757__auto__ = clojure.set.superset_QMARK_.call(null,re_com.validate.css_styles,arg_keys);
if(or__3757__auto__){
return or__3757__auto__;
} else {
...
*/
re_com.validate.html_attr_QMARK_ = (function html_attr_QMARK_(arg){
if(!(goog.DEBUG)){
return true;
} else {
var arg__$1 = re_com.util.deref_or_value.call(null,arg);
...
var result = ((contains_class_QMARK_)?":class not allowed in :attr argument":((contains_style_QMARK_)?":style not allowed in :attr argument":((!(clojure.set.superset_QMARK_.call(null,re_com.validate.html_attrs,arg_keys)))?[cljs.core.str("Unknown HTML attribute(s): "),cljs.core.str(cljs.core.remove.call(null,re_com.validate.html_attrs,arg_keys))].join(''):null)));
var or__3757__auto__ = (result == null);
if(or__3757__auto__){
return or__3757__auto__;
} else {
...
*/
re_com.validate.goog_date_QMARK_ = (function goog_date_QMARK_(arg){
var arg__$1 = re_com.util.deref_or_value.call(null,arg);
...
*/
re_com.validate.regex_QMARK_ = (function regex_QMARK_(arg){
var arg__$1 = re_com.util.deref_or_value.call(null,arg);
...
*/
re_com.validate.number_or_string_QMARK_ = (function number_or_string_QMARK_(arg){
var arg__$1 = re_com.util.deref_or_value.call(null,arg);
...
*/
re_com.validate.string_or_atom_QMARK_ = (function string_or_atom_QMARK_(arg){
...
*/
re_com.validate.set_or_atom_QMARK_ = (function set_or_atom_QMARK_(arg){
