...
*/
re_com.dropdown.move_to_new_choice = (function move_to_new_choice(choices,id_fn,id,offset){
...
*/
re_com.dropdown.choices_with_group_headings = (function choices_with_group_headings(opts,group_fn){
...
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"group","group",582596132)],[cljs.core.gensym.call(null),p1__5946_SHARP_]);
});})(groups))
...
*/
re_com.dropdown.filter_choices = (function filter_choices(choices,group_fn,label_fn,filter_text){
...
*/
re_com.dropdown.filter_choices_regex = (function filter_choices_regex(choices,group_fn,label_fn,filter_text){
var re = (function (){try{return (new RegExp(filter_text,"i"));
}catch (e5948){if((e5948 instanceof Object)){
var e = e5948;
return null;
} else {
throw e5948;
...
var or__3757__auto__ = re__$1.test(group_fn.call(null,opt));
...
*/
re_com.dropdown.filter_choices_by_keyword = (function filter_choices_by_keyword(choices,keyword,value){
var filter_fn = (function (opt){
return (keyword.call(null,opt).indexOf(value) >= (0));
});
return cljs.core.filter.call(null,filter_fn,choices);
});
re_com.dropdown.show_selected_item = (function show_selected_item(node){
...
var new_scroll_top = (((item_offset_bottom > parent_visible_bottom))?(function (){var x__4074__auto__ = (item_offset_bottom - parent_height);
var y__4075__auto__ = (0);
...
*/
re_com.dropdown.make_group_heading = (function make_group_heading(m){
...
*/
re_com.dropdown.choice_item = (function choice_item(id,label,on_click,internal_model){
...
re_com.dropdown.make_choice_item = (function make_choice_item(id_fn,label_fn,callback,internal_model,opt){
...
*/
re_com.dropdown.filter_text_box_base = (function filter_text_box_base(){
...
*/
re_com.dropdown.filter_text_box = cljs.core.with_meta.call(null,re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__5949_SHARP_){
var node = reagent.core.dom_node.call(null,p1__5949_SHARP_).firstChild;
return node.focus();
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__5950_SHARP_){
var node = reagent.core.dom_node.call(null,p1__5950_SHARP_).firstChild;
return node.focus();
})], null));
/**
* Render the top part of the dropdown, with the clickable area and the up/down arrow
*/
re_com.dropdown.dropdown_top = (function dropdown_top(){
...
var single_dropdown__delegate = function (p__5954){
var map__5960 = p__5954;
...
var args = map__5960__$1;
var model = cljs.core.get.call(null,map__5960__$1,new cljs.core.Keyword(null,"model","model",331153215));
...
return ((function (external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function() { 
var G__5965__delegate = function (p__5961){
...
var args__$1 = map__5962__$1;
var group_fn = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"group-fn","group-fn",129203707),new cljs.core.Keyword(null,"group","group",582596132));
var disabled_QMARK_ = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var model__$1 = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263),new cljs.core.Keyword(null,"label","label",1718410804));
var tab_index = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"tab-index","tab-index",895755393));
var max_height = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var placeholder = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var width = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var regex_filter_QMARK_ = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var choices = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798),new cljs.core.Keyword(null,"id","id",-1388402092));
var style = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var filter_box_QMARK_ = cljs.core.get.call(null,map__5962__$1,new cljs.core.Keyword(null,"filter-box?","filter-box?",-1157583688));
...
:null);
var changeable_QMARK_ = (function (){var and__3745__auto__ = on_change;
...
var callback = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (p1__5951_SHARP_){
cljs.core.reset_BANG_.call(null,internal_model,p1__5951_SHARP_);
...
});})(choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model))
;
var cancel = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (){
cljs.core.reset_BANG_.call(null,drop_showing_QMARK_,false);
...
});})(choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model))
;
var dropdown_click = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (){
...
var press_enter = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (){
if(cljs.core.truth_(disabled_QMARK___$1)){
cancel.call(null);
} else {
...
;
var press_escape = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (){
cancel.call(null);
...
;
var press_tab = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (){
if(cljs.core.truth_(disabled_QMARK___$1)){
cancel.call(null);
} else {
...
;
var press_up = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (){
if(cljs.core.truth_(cljs.core.deref.call(null,drop_showing_QMARK_))){
...
;
var press_down = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (){
if(cljs.core.truth_(cljs.core.deref.call(null,drop_showing_QMARK_))){
cljs.core.reset_BANG_.call(null,internal_model,re_com.dropdown.move_to_new_choice.call(null,filtered_choices,id_fn,cljs.core.deref.call(null,internal_model),(1)));
} else {
...
;
var press_home = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (){
...
;
var press_end = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (){
...
;
var key_handler = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,map__5962,map__5962__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model){
return (function (p1__5952_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__5963 = p1__5952_SHARP_.which;
switch (G__5963) {
case (13):
...
while (G__5967__i < G__5967__a.length) {G__5967__a[G__5967__i] = arguments[G__5967__i + 0]; ++G__5967__i;}
  p__5961 = new cljs.core.IndexedSeq(G__5967__a,0);
} 
return G__5965__delegate.call(this,p__5961);};
G__5965.cljs$lang$maxFixedArity = 0;
G__5965.cljs$lang$applyTo = (function (arglist__5968){
var p__5961 = cljs.core.seq(arglist__5968);
return G__5965__delegate(p__5961);
});
G__5965.cljs$core$IFn$_invoke$arity$variadic = G__5965__delegate;
return G__5965;
})()
;
;})(external_model,internal_model,drop_showing_QMARK_,filter_text,map__5960,map__5960__$1,args,model))
};
...
while (G__5969__i < G__5969__a.length) {G__5969__a[G__5969__i] = arguments[G__5969__i + 0]; ++G__5969__i;}
  p__5954 = new cljs.core.IndexedSeq(G__5969__a,0);
} 
return single_dropdown__delegate.call(this,p__5954);};
single_dropdown.cljs$lang$maxFixedArity = 0;
single_dropdown.cljs$lang$applyTo = (function (arglist__5970){
var p__5954 = cljs.core.seq(arglist__5970);
return single_dropdown__delegate(p__5954);
});
