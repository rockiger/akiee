...
function htmlForTodoListRow(todo, headline) {
    return "<tr onclick='LW.onClickTableRow(this);'><td>" + todo +"</td><td>" + headline + "</td><td onclick='LW.onClickUpRank(event, this);'>Up</td><td  onclick='LW.onClickDownRank(event, this);'>Down</td></tr>";
}
